            ...
            <tr>
                <td style="height: 25px; width: 100px;">
                    ...
                    <label for="nombre" id="nombre">Nombre completo</label>
                        ...
                        <input type="date" id="fechaNacimiento" name="fechaNacimiento" class="escribir" required><br><br>
                        ...
                        <table>
                            <tr>
                                <td>
                                    <button type="submit" value="Iniciar Sesion" id="Open" class="btn">Registrarse</button>
                                </td>
                                <td>
                ...
                <td style="text-align: center;">
                    ...
                    <h2 style="font-family: Verdana, Geneva, Tahoma, sans-serif;">Ingrese los datos solicitados para su registro</h2>
                    ...
                    <button type="submit" value="Iniciar Sesion" id="Open" class="btn" ><a href="PaginaLoginUser.php" align="center" class="btn">Iniciar sesión </a></button>
