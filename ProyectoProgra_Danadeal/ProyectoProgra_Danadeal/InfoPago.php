            ...
            <form name="infopago" id="infopago" action="Factura.php" method="POST">
                <table border="10" width="70%" align="center" bgcolor="pink" style="border-color:bisque">
                    ...
                    <tr>
                        <th>
                            ...
                            <br><br>
                            <input type="radio" name="pago" value="Efectivo" id="efectivo" onclick="mostrarEfectivo()" required>
                            <label for="Efectivo">Efectivo</label><br>
                            <input type="radio" name="pago" value="Tarjeta" id="tarjeta" onclick="mostrarTarjeta()" required>
                    ...
                    <tr>
                        <th>
                            <div id="Tarjeta" style="display:none">
                                ...
                                <br><br>
                                <label for="sinpe">Introduzca el número de tarjeta:</label>
                                <br><br>
                    ...
                    <tr>
                        <th>
                            ...
                            <br><br>
                            <input type="radio" name="entrega" value="tienda" id="tienda" onclick="mostrarTienda()" required>
                            <label for="tienda">Retirar en tienda</label><br>
                            <input type="radio" name="entrega" value="domicilio" id="domicilio" onclick="mostrarDomicilio()" required>
                    ...
                    <tr>
                        <th>
                            <div id="Tienda" style="display:none">
                                ...
                                <br><br>
                                <label for="sinpe">Introduzca la hora:</label>
                                <br><br>
                ...
                <table border="10" width="70%" align="center" bgcolor="pink" style="border-color:bisque">
                    <tr>
                        ...
                        <th colspan="2"><br>
                            <input type="number" name="Precio" id="Precio" value="<?php echo $_SESSION['PrecioTotalProductos'] ?>" readonly>
                            <input type="number" value="<?php echo  $_SESSION['PrecioTotalProductos'] ?>" style="display: none;" name="basedPrice" id="basedPrice">
                            <br><br>
                        </th>
                    <tr>
                </table>
                ...
                <table border="10" width="70%" align="center" bgcolor="pink" style="border-color:bisque">
                    <tr>
                        ...
                        <th colspan="2"><br>
                        <!--   En caso de que no funcione, lo que habia antes era $_REQUEST['Precio']-->
                            <input type="number" name="PrecioConIva" id="PrecioConIva" value="<?php echo (($_SESSION['PrecioTotalProductos'] * 0.13) + $_SESSION['PrecioTotalProductos'])  ?>" readonly>
                            <br><br>
                        </th>
                    <tr>
                </table>
                <br><br>
                <button type="sutmit" value="aceptar" name="aceptar" id="aceptar" class="ov-btn-grow-ellipse" onclick="mostrarCargando()"> Realizar pago</button>
                <button type="reset" value="cancelar" name="cancelar" class="ov-btn-grow-ellipse">Cancelar</button>

            </form>

            <a value="volver" name="volver" class="ov-btn-grow-ellipse" href="carritoCompras.php" style="text-decoration:none">Volver</a><br>
            <br><br>
