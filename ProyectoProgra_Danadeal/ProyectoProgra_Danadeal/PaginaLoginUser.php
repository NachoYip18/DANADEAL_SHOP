...
<body background="https://d1ih8jugeo2m5m.cloudfront.net/2022/11/proveedores-de-joyeria-mexico-1200x685.jpg" style="background-size: 100%">
    <div class="wrap">
        <table style="width: fit-content; height: fit-content; border-spacing: 30px 0px;">
                ...
                <td style="height: 25px; width: 100px;">
                    ...
                    <label for="user" id="cedula">Cédula</label>
                        ...
                        <table>
                            <tr>
                                <td>
                                    <button type="submit" value="Iniciar Sesion" id="Open" class="btn">Iniciar Sesión</button>
                                </td>
                                <td>
            ...
            window.location.href = 'InfoPago.php';
                ...
                <td style="text-align: center;">
                    ...
                    <h2 style="font-family: Verdana, Geneva, Tahoma, sans-serif;">Si usted está registrado en el sistema</h2>
                    <h2 style="font-family: Verdana, Geneva, Tahoma, sans-serif;">será redireccionado a la sección de pago.</h2>
                    <h2 style="font-family: Verdana, Geneva, Tahoma, sans-serif;">De lo contrario, tendrá que registrarse</h2>
                    <div style="margin-top: -25px">_____________________________________________________________</div>

                    <button type="submit" value="Volver" id="Open" class="btn" > <a href="Productos.php" align="center" class="btn">Volver</a></button>
                    <button type="submit" value="Registrarse" id="Open" class="btn" ><a href="RegistroUsuario.php" align="center" class="btn">Registrarse</a></button>
